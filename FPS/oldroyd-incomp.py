...
while j < loopend:
    ...
    while t < Tf + DOLFIN_EPS and iter < maxiter:
        ...
        SU = inner(We*dot(u1, grad(tau)), alpha_supg*dot(u1,grad(Rt)))*dx
    ...
    mplot(kapp)
    plt.colorbar()
    plt.savefig("o-b-kappa.png")
    plt.clf()
    f_corr = File("Paraview_Results/o-bStabilisation_Re="+str(Re*conv)+"We="+str(We)+"Ma="+str(Ma)+"b="+str(betav)+"/kappa-t= "+str(t)+".pvd")
    f_corr << kapp
    #quit()
    ...
    NN=150 # Must be a multiple of 3
    for i in range(NN/3):
        x_axis.append(-5.0 + (-r_a+5.0)*i/(NN/3))
    ...
    if j==loopend:
       ...
       plt.figure(4)
       plt.plot(x_axis1[0], sig_zz1[0], 'r-', label=r'$We=0.1$')
       plt.plot(x_axis1[1], sig_zz1[1], 'b-', label=r'$We=0.2$')
       plt.plot(x_axis1[2], sig_zz1[2], 'c-', label=r'$We=0.5$')
       plt.plot(x_axis1[3], sig_zz1[3], 'm-', label=r'$We=1.0$')
       plt.plot(x_axis1[4], sig_zz1[4], 'g-', label=r'$We=1.2$')
       plt.legend(loc='best')
       ...
       plt.close()
       plt.figure(5)
       plt.plot(x_axis1[0], sig_zr1[0], 'r-', label=r'$We=0.1$')
       plt.plot(x_axis1[1], sig_zr1[1], 'b-', label=r'$We=0.2$')
       plt.plot(x_axis1[2], sig_zr1[2], 'c-', label=r'$We=0.5$')
       plt.plot(x_axis1[3], sig_zr1[3], 'm-', label=r'$We=1.0$')
       plt.plot(x_axis1[4], sig_zr1[4], 'g-', label=r'$We=1.2$')
       plt.legend(loc='best')
       plt.xlabel('$x$', fontsize=16)
       ...
       plt.close()
       plt.figure(6)
       plt.plot(x_axis1[0], sig_rr1[0], 'r-', label=r'$We=0.1$')
       plt.plot(x_axis1[1], sig_rr1[1], 'b-', label=r'$We=0.2$')
       plt.plot(x_axis1[2], sig_rr1[2], 'c-', label=r'$We=0.5$')
       plt.plot(x_axis1[3], sig_rr1[3], 'm-', label=r'$We=1.0$')
       plt.plot(x_axis1[4], sig_rr1[4], 'g-', label=r'$We=1.2$')
       plt.legend(loc='best')
       plt.xlabel('$x$', fontsize=16)
    ...
    if max(norm(w1.vector(),'linf'),norm(p1.vector(), 'linf')) < 10E7 and j==loopend or j==1:
        # Kinetic Energy
        plt.figure(0)
        ...
        plt.plot(x5, ek5, 'g-', label=r'$We=1.2$')
        plt.legend(loc='best')
        plt.xlabel('time(s)')
        plt.ylabel('$E_k$')
        ...
        plt.plot(x5, ee5, 'g-', label=r'$We=1.2$')
        plt.legend(loc='best')
        plt.xlabel('time(s)')
        plt.ylabel('$E_e$')
        ...
        # Drag
        plt.figure(2)
        plt.plot(x1, fd1, 'r-', label=r'$We=0.1$')
        plt.plot(x2, fd2, 'b--', label=r'$We=0.2$')
        plt.plot(x3, fd3, 'c:', label=r'$We=0.5$')
        plt.plot(x4, fd4, 'm-.', label=r'$We=1.0$')
        plt.plot(x5, fd5, 'g-', label=r'$We=1.2$')
        plt.legend(loc='best')
        plt.xlabel('time(s)')
        plt.ylabel('$D^{*}$')
    ...
    if j==3 or j==loopend:
       ...
       # Plot Velocity Components
        ...
        mplot(ux)
        plt.colorbar()
        plt.savefig("Incompressible Viscoelastic Flow Results/Plots-Contours/o-bu_xRe="+str(Rey)+"We="+str(We)+"b="+str(betav)+"beta_s="+str(rat)+"t="+str(t)+".png")
        plt.clf()
        uy=project(u1[1],Q)
        fv_y << uy
        mplot(uy)
        plt.colorbar()
        plt.savefig("Incompressible Viscoelastic Flow Results/Plots-Contours/o-bu_yRe="+str(Rey)+"We="+str(We)+"b="+str(betav)+"beta_s="+str(rat)+"t="+str(t)+".png")
        plt.clf()
        mplot(p1)
        fp << p1
        plt.colorbar()
        plt.savefig("Incompressible Viscoelastic Flow Results/Plots-Contours/o-bPressureRe="+str(Re*conv)+"We="+str(We)+"b="+str(betav)+"beta_s="+str(rat)+"t="+str(t)+".png")
        plt.clf()

    if max(norm(tau1_vec.vector(),'linf'),norm(w1.vector(), 'linf')) < 10E6 and j==loopend or j==3:
        ...
        plt.colorbar() 
        plt.savefig("Incompressible Viscoelastic Flow Results/Plots-Contours/o-bPressureContoursRe="+str(Re*conv)+"We="+str(We)+"b="+str(betav)+"beta_s="+str(rat)+"t="+str(t)+".png")
        plt.clf()
        ...
        plt.savefig("Incompressible Viscoelastic Flow Results/Plots-Contours/o-bVelocityContoursRe="+str(Re*conv)+"We="+str(We)+"b="+str(betav)+"beta_s="+str(rat)+"t="+str(t)+".png")   
